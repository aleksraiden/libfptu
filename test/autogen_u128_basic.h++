...
TEST(u128, autogen_basic_0) {
  ...
  EXPECT_TRUE(A);
  EXPECT_EQ(U128::divmod(A, B).quotient, U128(UINT64_C(0x0000000000000007)));
  EXPECT_EQ(U128::divmod(A, B).remainder, U128(UINT64_C(0x10968ea5aec741b7)));
...
TEST(u128, autogen_basic_1) {
  ...
  EXPECT_TRUE(A);
  EXPECT_EQ(U128::divmod(A, B).quotient, U128(UINT64_C(0x03a117b09d99e048)));
  EXPECT_EQ(U128::divmod(A, B).remainder, U128(UINT64_C(0x60ba9ba483238500)));
...
TEST(u128, autogen_basic_2) {
  ...
  EXPECT_TRUE(A);
  EXPECT_EQ(U128::divmod(A, B).quotient, U128(UINT64_C(0x0000000000000000)));
  EXPECT_EQ(U128::divmod(A, B).remainder, U128(UINT64_C(0xac61292685c8f6c9)));
...
TEST(u128, autogen_basic_3) {
  ...
  EXPECT_TRUE(A);
  EXPECT_EQ(U128::divmod(A, B).quotient, U128(UINT64_C(0x0000000000000003)));
  EXPECT_EQ(U128::divmod(A, B).remainder, U128(UINT64_C(0x17066f48d3f24a8a), UINT64_C(0xafe7a65ce0148da4)));
...
TEST(u128, autogen_basic_4) {
  ...
  EXPECT_TRUE(A);
  EXPECT_EQ(U128::divmod(A, B).quotient, U128(UINT64_C(0x0000000000000000)));
  EXPECT_EQ(U128::divmod(A, B).remainder, U128(UINT64_C(0x4ab1ca18caaabc8a), UINT64_C(0xd8819fffff451b91)));
...
TEST(u128, autogen_basic_5) {
  ...
  EXPECT_TRUE(A);
  EXPECT_EQ(U128::divmod(A, B).quotient, U128(UINT64_C(0x0000000000000000)));
  EXPECT_EQ(U128::divmod(A, B).remainder, U128(UINT64_C(0xdac0fee655d98ade), UINT64_C(0x0000000000000000)));
...
TEST(u128, autogen_basic_6) {
  ...
  EXPECT_TRUE(A);
  EXPECT_EQ(U128::divmod(A, B).quotient, U128(UINT64_C(0x0000000000000000)));
  EXPECT_EQ(U128::divmod(A, B).remainder, U128(UINT64_C(0x1f7214451a93d740), UINT64_C(0x33a38607436d178f)));
...
TEST(u128, autogen_basic_7) {
  ...
  EXPECT_TRUE(A);
  EXPECT_EQ(U128::divmod(A, B).quotient, U128(UINT64_C(0x0000000000000000)));
  EXPECT_EQ(U128::divmod(A, B).remainder, U128(UINT64_C(0xc7d9bac453d18159), UINT64_C(0x0000000000000000)));
...
TEST(u128, autogen_basic_8) {
  ...
  EXPECT_TRUE(A);
  EXPECT_EQ(U128::divmod(A, B).quotient, U128(UINT64_C(0x0000000000000005), UINT64_C(0x77ca97ca5b4e1f73)));
  EXPECT_EQ(U128::divmod(A, B).remainder, U128(UINT64_C(0x070d67a01c581a64)));
...
TEST(u128, autogen_basic_9) {
  ...
  EXPECT_TRUE(A);
  EXPECT_EQ(U128::divmod(A, B).quotient, U128(UINT64_C(0x0000000000000000)));
  EXPECT_EQ(U128::divmod(A, B).remainder, U128(UINT64_C(0x5cdce323e9ac3e9d)));
...
TEST(u128, autogen_basic_10) {
  ...
  EXPECT_TRUE(A);
  EXPECT_EQ(U128::divmod(A, B).quotient, U128(UINT64_C(0x0000000000000001)));
  EXPECT_EQ(U128::divmod(A, B).remainder, U128(UINT64_C(0x208ffcd474e09a17), UINT64_C(0xc77a56fd01417243)));
...
TEST(u128, autogen_basic_11) {
  ...
  EXPECT_TRUE(A);
  EXPECT_EQ(U128::divmod(A, B).quotient, U128(UINT64_C(0x0000000000000000)));
  EXPECT_EQ(U128::divmod(A, B).remainder, U128(UINT64_C(0x36f26ae0bb288e1c), UINT64_C(0x107465900254603b)));
...
TEST(u128, autogen_basic_12) {
  ...
  EXPECT_TRUE(A);
  EXPECT_EQ(U128::divmod(A, B).quotient, U128(UINT64_C(0x0000000000000001)));
  EXPECT_EQ(U128::divmod(A, B).remainder, U128(UINT64_C(0x24e3e98ae2323137)));
...
TEST(u128, autogen_basic_13) {
  ...
  EXPECT_TRUE(A);
  EXPECT_EQ(U128::divmod(A, B).quotient, U128(UINT64_C(0x000000000000000d), UINT64_C(0xd163ebcb3795fafa)));
  EXPECT_EQ(U128::divmod(A, B).remainder, U128(UINT64_C(0x0ea43a0e82b580ff)));
...
TEST(u128, autogen_basic_14) {
  ...
  EXPECT_TRUE(A);
  EXPECT_EQ(U128::divmod(A, B).quotient, U128(UINT64_C(0x0000000000000000)));
  EXPECT_EQ(U128::divmod(A, B).remainder, U128(UINT64_C(0xa2d937a7c1738fe9)));
...
TEST(u128, autogen_basic_15) {
  ...
  EXPECT_TRUE(A);
  EXPECT_EQ(U128::divmod(A, B).quotient, U128(UINT64_C(0x0000000000000002)));
  EXPECT_EQ(U128::divmod(A, B).remainder, U128(UINT64_C(0x12ae584083dd14bb)));
...
TEST(u128, autogen_basic_16) {
  ...
  EXPECT_TRUE(A);
  EXPECT_EQ(U128::divmod(A, B).quotient, U128(UINT64_C(0x67196416f31c093b)));
  EXPECT_EQ(U128::divmod(A, B).remainder, U128(UINT64_C(0x3f7cf04549dd5e26)));
...
TEST(u128, autogen_basic_17) {
  ...
  EXPECT_TRUE(A);
  EXPECT_EQ(U128::divmod(A, B).quotient, U128(UINT64_C(0x0000000000000000)));
  EXPECT_EQ(U128::divmod(A, B).remainder, U128(UINT64_C(0x20a1d49037df78b1)));
...
TEST(u128, autogen_basic_18) {
  ...
  EXPECT_TRUE(A);
  EXPECT_EQ(U128::divmod(A, B).quotient, U128(UINT64_C(0x0000000000000000)));
  EXPECT_EQ(U128::divmod(A, B).remainder, U128(UINT64_C(0x13fcfcdc55c1aa7e), UINT64_C(0x9a0bb540c15cfb75)));
...
TEST(u128, autogen_basic_19) {
  ...
  EXPECT_TRUE(A);
  EXPECT_EQ(U128::divmod(A, B).quotient, U128(UINT64_C(0x0000000000000006)));
  EXPECT_EQ(U128::divmod(A, B).remainder, U128(UINT64_C(0x05b3cb8baa13f0d2), UINT64_C(0x06bd0d75772dfc5f)));
...
TEST(u128, autogen_basic_20) {
  ...
  EXPECT_TRUE(A);
  EXPECT_EQ(U128::divmod(A, B).quotient, U128(UINT64_C(0x0000000000000000)));
  EXPECT_EQ(U128::divmod(A, B).remainder, U128(UINT64_C(0x0106449e4a1b66e6), UINT64_C(0x0000000000000000)));
...
TEST(u128, autogen_basic_21) {
  ...
  EXPECT_TRUE(A);
  EXPECT_EQ(U128::divmod(A, B).quotient, U128(UINT64_C(0x0000000000000000)));
  EXPECT_EQ(U128::divmod(A, B).remainder, U128(UINT64_C(0x019b8878dcae8288), UINT64_C(0x010b4072adfdeb37)));
...
TEST(u128, autogen_basic_22) {
  ...
  EXPECT_TRUE(A);
  EXPECT_EQ(U128::divmod(A, B).quotient, U128(UINT64_C(0x0000000000000001)));
  EXPECT_EQ(U128::divmod(A, B).remainder, U128(UINT64_C(0x45b8a65453c58a47), UINT64_C(0x0000000000000000)));
...
TEST(u128, autogen_basic_23) {
  ...
  EXPECT_TRUE(A);
  EXPECT_EQ(U128::divmod(A, B).quotient, U128(UINT64_C(0xdead2db3806b0714)));
  EXPECT_EQ(U128::divmod(A, B).remainder, U128(UINT64_C(0x23a5a65fa8d6bd50)));
...
TEST(u128, autogen_basic_24) {
  ...
  EXPECT_TRUE(A);
  EXPECT_EQ(U128::divmod(A, B).quotient, U128(UINT64_C(0x0000000000000000)));
  EXPECT_EQ(U128::divmod(A, B).remainder, U128(UINT64_C(0xaa6c2dff00565905)));
...
TEST(u128, autogen_basic_25) {
  ...
  EXPECT_TRUE(A);
  EXPECT_EQ(U128::divmod(A, B).quotient, U128(UINT64_C(0x0000000000000002)));
  EXPECT_EQ(U128::divmod(A, B).remainder, U128(UINT64_C(0x28095de5aeb0bb9e), UINT64_C(0x607f32e6be2dd364)));
...
TEST(u128, autogen_basic_26) {
  ...
  EXPECT_TRUE(A);
  EXPECT_EQ(U128::divmod(A, B).quotient, U128(UINT64_C(0x0000000000000000)));
  EXPECT_EQ(U128::divmod(A, B).remainder, U128(UINT64_C(0x916da6ab3601fee4), UINT64_C(0x4b18dc4b7de86b63)));
...
TEST(u128, autogen_basic_27) {
  ...
  EXPECT_TRUE(A);
  EXPECT_EQ(U128::divmod(A, B).quotient, U128(UINT64_C(0x0000000000000000)));
  EXPECT_EQ(U128::divmod(A, B).remainder, U128(UINT64_C(0xffffffffffffffff), UINT64_C(0x58c56cc28d23114d)));
...
TEST(u128, autogen_basic_28) {
  ...
  EXPECT_TRUE(A);
  EXPECT_EQ(U128::divmod(A, B).quotient, U128(UINT64_C(0x0000000000000001), UINT64_C(0x2a1e330cca3660af)));
  EXPECT_EQ(U128::divmod(A, B).remainder, U128(UINT64_C(0x2f7b9d5a49dcbf9f)));
...
TEST(u128, autogen_basic_29) {
  ...
  EXPECT_TRUE(A);
  EXPECT_EQ(U128::divmod(A, B).quotient, U128(UINT64_C(0x0000000000000000)));
  EXPECT_EQ(U128::divmod(A, B).remainder, U128(UINT64_C(0x00d85b578395e5d1)));
...
TEST(u128, autogen_basic_30) {
  ...
  EXPECT_TRUE(A);
  EXPECT_EQ(U128::divmod(A, B).quotient, U128(UINT64_C(0x0000000000000003)));
  EXPECT_EQ(U128::divmod(A, B).remainder, U128(UINT64_C(0x1c47e46cf7fc1347)));
...
TEST(u128, autogen_basic_31) {
  ...
  EXPECT_TRUE(A);
  EXPECT_EQ(U128::divmod(A, B).quotient, U128(UINT64_C(0x5ae382252f1cc90b)));
  EXPECT_EQ(U128::divmod(A, B).remainder, U128(UINT64_C(0x2418adfb6dc5cb36)));
...
TEST(u128, autogen_basic_32) {
  ...
  EXPECT_TRUE(A);
  EXPECT_EQ(U128::divmod(A, B).quotient, U128(UINT64_C(0x0000000000000000)));
  EXPECT_EQ(U128::divmod(A, B).remainder, U128(UINT64_C(0x8b4b8e14fcacd399)));
...
TEST(u128, autogen_basic_33) {
  ...
  EXPECT_TRUE(A);
  EXPECT_EQ(U128::divmod(A, B).quotient, U128(UINT64_C(0x0000000000000000)));
  EXPECT_EQ(U128::divmod(A, B).remainder, U128(UINT64_C(0x5433e83a3805ea86), UINT64_C(0xd4d67e2507c834dd)));
...
TEST(u128, autogen_basic_34) {
  ...
  EXPECT_TRUE(A);
  EXPECT_EQ(U128::divmod(A, B).quotient, U128(UINT64_C(0x0000000000000000)));
  EXPECT_EQ(U128::divmod(A, B).remainder, U128(UINT64_C(0x13135f907740a09a), UINT64_C(0xdd7b8e6a2f122261)));
...
TEST(u128, autogen_basic_35) {
  ...
  EXPECT_TRUE(A);
  EXPECT_EQ(U128::divmod(A, B).quotient, U128(UINT64_C(0x0000000000000001)));
  EXPECT_EQ(U128::divmod(A, B).remainder, U128(UINT64_C(0x2d77769daf16e491), UINT64_C(0x21e2fad4cd59bb85)));
...
TEST(u128, autogen_basic_36) {
  ...
  EXPECT_TRUE(A);
  EXPECT_EQ(U128::divmod(A, B).quotient, U128(UINT64_C(0x0000000000000002)));
  EXPECT_EQ(U128::divmod(A, B).remainder, U128(UINT64_C(0x06bc67aa61f68286), UINT64_C(0x678a7a88e7c46fdf)));
...
TEST(u128, autogen_basic_37) {
  ...
  EXPECT_TRUE(A);
  EXPECT_EQ(U128::divmod(A, B).quotient, U128(UINT64_C(0x0000000000000000)));
  EXPECT_EQ(U128::divmod(A, B).remainder, U128(UINT64_C(0x4fbe679492aef229), UINT64_C(0x0000000000000000)));
...
TEST(u128, autogen_basic_38) {
  ...
  EXPECT_TRUE(A);
  EXPECT_EQ(U128::divmod(A, B).quotient, U128(UINT64_C(0x0d78325745873db0)));
  EXPECT_EQ(U128::divmod(A, B).remainder, U128(UINT64_C(0x29767975c8270140)));
...
TEST(u128, autogen_basic_39) {
  ...
  EXPECT_TRUE(A);
  EXPECT_EQ(U128::divmod(A, B).quotient, U128(UINT64_C(0x0000000000000000)));
  EXPECT_EQ(U128::divmod(A, B).remainder, U128(UINT64_C(0x9c5f5d034cbb1c6d)));
...
TEST(u128, autogen_basic_40) {
  ...
  EXPECT_TRUE(A);
  EXPECT_EQ(U128::divmod(A, B).quotient, U128(UINT64_C(0x0000000000000003)));
  EXPECT_EQ(U128::divmod(A, B).remainder, U128(UINT64_C(0x27b34e10737c4596), UINT64_C(0xfeb16ed7ae56dd35)));
...
TEST(u128, autogen_basic_41) {
  ...
  EXPECT_TRUE(A);
  EXPECT_EQ(U128::divmod(A, B).quotient, U128(UINT64_C(0x0000000000000000)));
  EXPECT_EQ(U128::divmod(A, B).remainder, U128(UINT64_C(0xf0ce7db4f84374ac), UINT64_C(0xb632539a0a40578b)));
...
TEST(u128, autogen_basic_42) {
  ...
  EXPECT_TRUE(A);
  EXPECT_EQ(U128::divmod(A, B).quotient, U128(UINT64_C(0x0000000000000001)));
  EXPECT_EQ(U128::divmod(A, B).remainder, U128(UINT64_C(0xd0ed7ce8de0c2ff7)));
...
TEST(u128, autogen_basic_43) {
  ...
  EXPECT_TRUE(A);
  EXPECT_EQ(U128::divmod(A, B).quotient, U128(UINT64_C(0x0000000000000001), UINT64_C(0x0223512ae0934b5d)));
  EXPECT_EQ(U128::divmod(A, B).remainder, U128(UINT64_C(0x7918fb530fd1cb4f)));
...
TEST(u128, autogen_basic_44) {
  ...
  EXPECT_TRUE(A);
  EXPECT_EQ(U128::divmod(A, B).quotient, U128(UINT64_C(0x0000000000000000)));
  EXPECT_EQ(U128::divmod(A, B).remainder, U128(UINT64_C(0xfe87c5290a8794b9)));
...
TEST(u128, autogen_basic_45) {
  ...
  EXPECT_TRUE(A);
  EXPECT_EQ(U128::divmod(A, B).quotient, U128(UINT64_C(0x0000000000000000)));
  EXPECT_EQ(U128::divmod(A, B).remainder, U128(UINT64_C(0x51907aec85f8ce93)));
...
TEST(u128, autogen_basic_46) {
  ...
  EXPECT_TRUE(A);
  EXPECT_EQ(U128::divmod(A, B).quotient, U128(UINT64_C(0x0000000000000001), UINT64_C(0x045c9ba34b3be718)));
  EXPECT_EQ(U128::divmod(A, B).remainder, U128(UINT64_C(0x4b6db9f727760e38)));
...
TEST(u128, autogen_basic_47) {
  ...
  EXPECT_TRUE(A);
  EXPECT_EQ(U128::divmod(A, B).quotient, U128(UINT64_C(0x0000000000000000)));
  EXPECT_EQ(U128::divmod(A, B).remainder, U128(UINT64_C(0xedc0b8f72169a781)));
...
TEST(u128, autogen_basic_48) {
  ...
  EXPECT_TRUE(A);
  EXPECT_EQ(U128::divmod(A, B).quotient, U128(UINT64_C(0x0000000000000001)));
  EXPECT_EQ(U128::divmod(A, B).remainder, U128(UINT64_C(0x14921e87c7390592), UINT64_C(0x8087be34e4c368aa)));
...
TEST(u128, autogen_basic_49) {
  ...
  EXPECT_TRUE(A);
  EXPECT_EQ(U128::divmod(A, B).quotient, U128(UINT64_C(0x0000000000000000)));
  EXPECT_EQ(U128::divmod(A, B).remainder, U128(UINT64_C(0x1a073e52a8886e22), UINT64_C(0x4110cdb677cfbb49)));
...
TEST(u128, autogen_basic_50) {
  ...
  EXPECT_TRUE(A);
  EXPECT_EQ(U128::divmod(A, B).quotient, U128(UINT64_C(0x0000000000000001)));
  EXPECT_EQ(U128::divmod(A, B).remainder, U128(UINT64_C(0x0d9bbdd99ebf81d1), UINT64_C(0x6283eeed26dcc85d)));
...
TEST(u128, autogen_basic_51) {
  ...
  EXPECT_TRUE(A);
  EXPECT_EQ(U128::divmod(A, B).quotient, U128(UINT64_C(0x0000000000000005)));
  EXPECT_EQ(U128::divmod(A, B).remainder, U128(UINT64_C(0x088fcdec4f402257), UINT64_C(0x5cb64544ca584587)));
...
TEST(u128, autogen_basic_52) {
  ...
  EXPECT_TRUE(A);
  EXPECT_EQ(U128::divmod(A, B).quotient, U128(UINT64_C(0x0000000000000001)));
  EXPECT_EQ(U128::divmod(A, B).remainder, U128(UINT64_C(0x142955b5d47a3d07), UINT64_C(0x0000000000000000)));
...
TEST(u128, autogen_basic_53) {
  ...
  EXPECT_TRUE(A);
  EXPECT_EQ(U128::divmod(A, B).quotient, U128(UINT64_C(0x0000000000000002), UINT64_C(0xdd7121904a1adc33)));
  EXPECT_EQ(U128::divmod(A, B).remainder, U128(UINT64_C(0x1295445c5a94a7dc)));
...
TEST(u128, autogen_basic_54) {
  ...
  EXPECT_TRUE(A);
  EXPECT_EQ(U128::divmod(A, B).quotient, U128(UINT64_C(0x0000000000000000)));
  EXPECT_EQ(U128::divmod(A, B).remainder, U128(UINT64_C(0x2d4ad35849c528d5)));
...
TEST(u128, autogen_basic_55) {
  ...
  EXPECT_TRUE(A);
  EXPECT_EQ(U128::divmod(A, B).quotient, U128(UINT64_C(0x0000000000000002)));
  EXPECT_EQ(U128::divmod(A, B).remainder, U128(UINT64_C(0x3171d024836b4c7d), UINT64_C(0xddcf47b6c3cdccd4)));
...
TEST(u128, autogen_basic_56) {
  ...
  EXPECT_TRUE(A);
  EXPECT_EQ(U128::divmod(A, B).quotient, U128(UINT64_C(0x0000000000000000)));
  EXPECT_EQ(U128::divmod(A, B).remainder, U128(UINT64_C(0x17995e79c82d0f74), UINT64_C(0x5a82ab69f081c4b3)));
...
TEST(u128, autogen_basic_57) {
  ...
  EXPECT_TRUE(A);
  EXPECT_EQ(U128::divmod(A, B).quotient, U128(UINT64_C(0x0000000000000001)));
  EXPECT_EQ(U128::divmod(A, B).remainder, U128(UINT64_C(0x253d47ba70c58957)));
...
TEST(u128, autogen_basic_58) {
  ...
  EXPECT_TRUE(A);
  EXPECT_EQ(U128::divmod(A, B).quotient, U128(UINT64_C(0x0000000000000002), UINT64_C(0x6bb07f05bdcde169)));
  EXPECT_EQ(U128::divmod(A, B).remainder, U128(UINT64_C(0x16e8cdc67b5c78ef)));
...
TEST(u128, autogen_basic_59) {
  ...
  EXPECT_TRUE(A);
  EXPECT_EQ(U128::divmod(A, B).quotient, U128(UINT64_C(0x0000000000000000)));
  EXPECT_EQ(U128::divmod(A, B).remainder, U128(UINT64_C(0xc5a8802f37513ca1)));
...
TEST(u128, autogen_basic_60) {
  ...
  EXPECT_TRUE(A);
  EXPECT_EQ(U128::divmod(A, B).quotient, U128(UINT64_C(0x0000000000000001)));
  EXPECT_EQ(U128::divmod(A, B).remainder, U128(UINT64_C(0x159ed21a2f1a601f)));
...
TEST(u128, autogen_basic_61) {
  ...
  EXPECT_TRUE(A);
  EXPECT_EQ(U128::divmod(A, B).quotient, U128(UINT64_C(0x271131b0f01047fd)));
  EXPECT_EQ(U128::divmod(A, B).remainder, U128(UINT64_C(0x69d5d32f839f119a)));
...
TEST(u128, autogen_basic_62) {
  ...
  EXPECT_TRUE(A);
  EXPECT_EQ(U128::divmod(A, B).quotient, U128(UINT64_C(0x0000000000000000)));
  EXPECT_EQ(U128::divmod(A, B).remainder, U128(UINT64_C(0x94ffa87556529469)));
  EXPECT_EQ(A >> 66, U128(UINT64_C(0x0000000000000000)));
...
TEST(u128, autogen_basic_63) {
  ...
  EXPECT_TRUE(A);
  EXPECT_EQ(U128::divmod(A, B).quotient, U128(UINT64_C(0x0000000000000000)));
  EXPECT_EQ(U128::divmod(A, B).remainder, U128(UINT64_C(0xe818098b67d7f196), UINT64_C(0xd1a14d4a7d8462ad)));
...
TEST(u128, autogen_basic_64) {
  ...
  EXPECT_TRUE(A);
  EXPECT_EQ(U128::divmod(A, B).quotient, U128(UINT64_C(0x0000000000000000)));
  EXPECT_EQ(U128::divmod(A, B).remainder, U128(UINT64_C(0x2606ce30ca90f8aa), UINT64_C(0x88529ca5b1318d31)));
...
TEST(u128, autogen_basic_65) {
  ...
  EXPECT_TRUE(A);
  EXPECT_EQ(U128::divmod(A, B).quotient, U128(UINT64_C(0x0000000000000001)));
  EXPECT_EQ(U128::divmod(A, B).remainder, U128(UINT64_C(0x476252b6cf55a711), UINT64_C(0xfe4be924a962f435)));
...
TEST(u128, autogen_basic_66) {
  ...
  EXPECT_TRUE(A);
  EXPECT_EQ(U128::divmod(A, B).quotient, U128(UINT64_C(0x0000000000000000)));
  EXPECT_EQ(U128::divmod(A, B).remainder, U128(UINT64_C(0x43dc49ff36ed8260), UINT64_C(0x68b0ff6cd4b50c2f)));
...
TEST(u128, autogen_basic_67) {
  ...
  EXPECT_TRUE(A);
  EXPECT_EQ(U128::divmod(A, B).quotient, U128(UINT64_C(0x0000000000000003)));
  EXPECT_EQ(U128::divmod(A, B).remainder, U128(UINT64_C(0x24aa8293cd1c6343), UINT64_C(0x0000000000000000)));
...
TEST(u128, autogen_basic_68) {
  ...
  EXPECT_TRUE(A);
  EXPECT_EQ(U128::divmod(A, B).quotient, U128(UINT64_C(0x0000000000000001), UINT64_C(0x30810cee93ae1ba3)));
  EXPECT_EQ(U128::divmod(A, B).remainder, U128(UINT64_C(0x303122b4c8821144)));
...
TEST(u128, autogen_basic_69) {
  ...
  EXPECT_TRUE(A);
  EXPECT_EQ(U128::divmod(A, B).quotient, U128(UINT64_C(0x0000000000000000)));
  EXPECT_EQ(U128::divmod(A, B).remainder, U128(UINT64_C(0xd4edca5446a31e3d)));
...
TEST(u128, autogen_basic_70) {
  ...
  EXPECT_TRUE(A);
  EXPECT_EQ(U128::divmod(A, B).quotient, U128(UINT64_C(0x0000000000000001)));
  EXPECT_EQ(U128::divmod(A, B).remainder, U128(UINT64_C(0x51fd2601fc6aeaf6), UINT64_C(0x824a27c22265cdc3)));
...
TEST(u128, autogen_basic_71) {
  ...
  EXPECT_TRUE(A);
  EXPECT_EQ(U128::divmod(A, B).quotient, U128(UINT64_C(0x0000000000000000)));
  EXPECT_EQ(U128::divmod(A, B).remainder, U128(UINT64_C(0x23372fea4f32ef3c), UINT64_C(0xe2569a3035f652db)));
...
TEST(u128, autogen_basic_72) {
  ...
  EXPECT_TRUE(A);
  EXPECT_EQ(U128::divmod(A, B).quotient, U128(UINT64_C(0x0000000000000000)));
  EXPECT_EQ(U128::divmod(A, B).remainder, U128(UINT64_C(0xffffffffffffffff), UINT64_C(0x108969eb3b3ed585)));
...
TEST(u128, autogen_basic_73) {
  ...
  EXPECT_TRUE(A);
  EXPECT_EQ(U128::divmod(A, B).quotient, U128(UINT64_C(0x0000000000000004), UINT64_C(0x953679c2184342a9)));
  EXPECT_EQ(U128::divmod(A, B).remainder, U128(UINT64_C(0x34bff30e78872c0f)));
...
TEST(u128, autogen_basic_74) {
  ...
  EXPECT_TRUE(A);
  EXPECT_EQ(U128::divmod(A, B).quotient, U128(UINT64_C(0x0000000000000000)));
  EXPECT_EQ(U128::divmod(A, B).remainder, U128(UINT64_C(0x34156830ffff7d89)));
